  ...
  return (
    <div className="service">
      ...
      <p>
        ...
        main reason why you have to take your vehicle to the proper maintenance
        and also through the proper servicing, you could diagnose the issues of
        your vehicle before it causes serious damage. In addition, preventive
        maintenance is cheaper than carrying out a car repair, so you will also
        be taking care of your pocket.
      </p>
      <p>
